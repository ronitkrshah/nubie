...
export default abstract class NubieExtensionMethodDecorator {
    abstract executeAsync(req: Request, res: Response, next: NextFunction): Promise<void>;

    public static createDecorator<T extends any[]>(MethodDecorator: new (...args: T) => NubieExtensionMethodDecorator) {
