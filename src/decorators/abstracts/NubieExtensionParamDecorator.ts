...
export default abstract class NubieExtensionParamDecorator {
    ...
    public static createDecorator<T extends any[]>(MethodDecorator: new (...args: T) => NubieExtensionParamDecorator) {
